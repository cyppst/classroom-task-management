                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <hr>
                             ...
                             <p><a href="pdf_stu.php?sub_id=<?=$objResult2["sub_id"]?>">จัดการข้อมูลการสอบ</a><span class="glyphicon glyphicon-chevron-right"></span><span class="glyphicon glyphicon-chevron-right"></span><span class="glyphicon glyphicon-chevron-right">เพิ่มหัวข้อ<span class="glyphicon glyphicon-chevron-right"></span><span class="glyphicon glyphicon-chevron-right"></span><font color="red" >จัดการข้อมูลการสอบ</font></p>
...
<td>
<div align="center">
  <A HREF="exam_edit.php?exa_id=<?=$objResult3["exa_id"]?>&sub_id=<?=$objResult2["sub_id"]?>" title="แก้ไข" class="btn btn-info" ><i class="fa fa-edit"></i></a>
 
<A HREF="exam_frm_del.php?exa_id=<?=$objResult3["exa_id"]?>" title="ลบ" class="btn btn-danger"  onclick="return confirm('คุณต้องการลบหรือไม่ Y/N');"><i class="fa fa-close" ></i></a></div>
</td>
   <td>  </td>                
                    </tr>
                   <?php
