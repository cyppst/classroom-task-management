...
$strSQL ="SELECT * FROM work Left join work_score ON (work.work_id=work_score.work_id) Left join student ON (work_score.std_id=student.std_id)  WHERE work_score.regis_section = '".$_GET["sub_id"]."' AND  student.std_id = '".$_SESSION['UserID']."' GROUP BY work_score.std_id ";
...
function renderScore($txt){
  switch ($txt) {
    case 0: return "<font color=\"red\">ไม่ส่ง</font>"; break;
    case 1: return "<font color=\"green\">ส่ง</font>"; break;
