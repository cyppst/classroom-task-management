...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="subject_tech.php">เพิ่มวิชา</a>
    </li>  
    <li class="breadcrumb-item active">ข้อมูลวิชา</li>
      ...
      <div class="content">
                <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-9 ml-auto mr-auto">
                                    ...
                                    <div class="card-body">      
                                         ...
                                         <form action="tech_save_subject.php" name="form1" method="post" onSubmit="JavaScript:return fncSubmit();">
                    ...
                    <hr>
                                     <center>  
                                      <a href="subject_tech.php"><button type="button" class="btn btn-success btn-fill"> ย้อนกลับ</button></a>
