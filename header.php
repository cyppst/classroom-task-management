            ...
            <div class="sidebar" data-image="../assets/img/sidebar-3.jpg">
                ...
                <div class="sidebar-wrapper">
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item <?php if($page == "main_tech"){ echo "active"; }?>">
                            <a class="nav-link" href="./main_tech.php">
                                <i class="nc-icon nc-circle-09"></i>
                                <p>จัดการข้อมูลส่วนตัว</p>
                            </a>
                        </li>
                        <li class="nav-item <?php if($page == "main_stu"){ echo "active"; }?>">
                            <a class="nav-link" href="./main_stu.php">
                                <i class="nc-icon nc-badge"></i>
                                <p>จัดการข้อมูลนักศึกษา</p>
                            </a>
                        </li>
                        <li class="nav-item <?php if($page == "sub_tech"){ echo "active"; }?>">
                            <a class="nav-link" href="./subject_tech.php">
                        ...
                        <li class="nav-item <?php if($page == "regis"){ echo "active"; }?>">
                            <a class="nav-link" href="./main_subject.php">
                                <i class="nc-icon nc-paper-2"></i>
                                <p>รายการลงทะเบียน</p>
                            </a>
                        </li>
                        
                        <li class="nav-item <?php if($page == "pdffile"){ echo "active"; }?>">
                            <a class="nav-link" href="./pdffile.php">
