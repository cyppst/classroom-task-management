...
$strSQL6 ="SELECT student.std_id,student.std_number,student.std_name,student.std_lname,SUM(ex_list_score) as score FROM examination_list Left join student ON (examination_list.std_id=student.std_id)  WHERE examination_list.regis_section = '".$_GET["sub_id"]."' GROUP BY student.std_id ";
