...
<ol class="breadcrumb">
    <li class="breadcrumb-item active"><h4>จัดการข้อมูลคาบเรียน&nbsp;/&nbsp;แก้ไขคาบเรียน</h4></li>
...
<td>
<div align="center">
  <A HREF="edit_cn.php?cn_id=<?=$objResult3["cn_id"]?>&sub_id=<?=$objResult2["sub_id"]?>" title="แก้ไข" class="btn btn-info" onclick="return confirm('อาจมีผลกับคะแนนคุณต้องการแก้ไขหรือไม่ Y/N');" ><i class="fa fa-edit"></i></a>
 
<A HREF="cn_frm_del.php?cn_id=<?=$objResult3["cn_id"]?>" title="ลบ" class="btn btn-danger"  onclick="return confirm('อาจมีผลกับคะแนนคุณต้องการลบหรือไม่ Y/N');"><i class="fa fa-close" ></i></a></div></td>
...
?><tr>
            ...
            <div align="left"><a href="cn_frm.php?sub_id=<?=$objResult2["sub_id"]?>"><button type="button" class="btn btn-primary"> ย้อนกลับ</button></a>
            </div>
                    </div>
                </div>
            </div>
