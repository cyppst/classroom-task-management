...
$strSQL6 ="SELECT student.std_id,student.std_number,student.std_name,student.std_lname,SUM(score) as score FROM work_score Left join student ON (work_score.std_id=student.std_id)  WHERE work_score.regis_section = '".$_GET["sub_id"]."' AND  student.std_id = '".$_SESSION['UserID']."' GROUP BY student.std_id ";
