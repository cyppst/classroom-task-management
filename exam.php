...
<ol class="breadcrumb">
    <li class="breadcrumb-item active"><h4>จัดการข้อมูลการสอบ&nbsp;/&nbsp;เพิ่มหัวข้อการสอบ</h4></li>
...
//-->
                        ...
                        <div class="card-body">   
                          ...
                          <a href="exam_data.php?sub_id=<?=$objResult2["sub_id"]?>" class="btn btn-success" ><p class="glyphicon glyphicon-plus-sign">จัดการข้อมูลการสอบ</p></a> 
<center><form action="exam_save.php?sub_id=<?=$objResult2["sub_id"]?>" name="frmAdd" method="post">
จำนวนบทที่ : 
...
<table width="200" class="table table-bordered" border="1">
  <tr>
    ...
    <th width="160"> <div align="center">หัวข้อ </div></th>
