...
$strSQL = "INSERT INTO checkname_score ";
$strSQL .="(cn_id,std_id,score,regis_section) ";
$strSQL .="VALUES ";
$strSQL .="('".$cn_id."','".$_POST['std_id'][$j]."','".$_POST['std_name'][$j]."','".$_POST['sub_id'][$j]."') ";
   ...
   <script> 
      swal({
        ...
        closeOnConfirm: false
          ...
          if (isConfirm) {     
            window.location.href = "cn_frmz.php?sub_id=<?php echo $sub; ?>&cn_id=<?php echo $cn_id; ?>";
      } 
});
        </script>
</script>
...
{
  window.open('cn_frm_show.php?sub_id"<?=$objResult2["sub_id"]?>')
}
</script>