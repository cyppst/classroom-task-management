...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="subject_admin.php">วิชา</a>
    </li>  
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="col-md-6 pl-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="su_name"  value="<?php echo $objResult["su_name"];?>" placeholder="กรอกชื่อวิชา" maxlength="13" required>
                                            </div>
                                        </div>
                                        </div>
