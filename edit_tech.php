 ...
 <script> 
      swal({
        ...
        closeOnConfirm: false
          ...
          if (isConfirm) {     
            window.location.href = "main_tech.php";
      } 
});
        </script>
<?php
...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="main_tech.php">อาจารย์</a>
    </li>  
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="col-md-6 pl-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="tech_phone" value="<?php echo $objResult["tech_phone"];?>" placeholder="กรอก ID Line" maxlength="10" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" required>
                                            </div>
                                        </div>
                                        </div>
										...
										<hr>
 <center>
<a href="main_tech.php"><button type="button" class="btn btn-success btn-fill"> ย้อนกลับ</button></a>
