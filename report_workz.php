...
$sql2="SELECT * FROM work_score WHERE std_id = '".$eachResult["std_id"]."' and regis_section = '".$_GET["sub_id"]."' and work_id = '".$_GET["work_id"]."'";
...
$result2 = mysqli_fetch_array($objQuery2);
		...
		$this->Cell(35,6,$result2["score"],1,0,'C');
...
$strSQL16 ="SELECT count(std_id) as std FROM work_score WHERE regis_section = '".$_GET["sub_id"]."'  and work_id = '".$_GET["work_id"]."' and score = '0' ";
...
$pdf->SetY(20);
	$pdf->SetX(30);
	$pdf->Cell(0,0,iconv('UTF-8','TIS-620','รายงานคะแนนการส่งงาน'),0,0,"R");
$pdf->SetY(23);
	$pdf->SetX(30);
