                                ...
                                <div class="col-md-9 ml-auto mr-auto">
                                    <div class="card">
                                        ...
                                        <div class="card-body">      
                                         ...
                                         <form action="cn_data_score_save.php?sub_id=<?=$objResult2["sub_id"]?>" name="form1" method="post" onSubmit="JavaScript:return fncSubmit();">
                                        ...
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="text_score"  class="form-control" placeholder="กรอกคะแนน" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"/>
                                            </div>
                                        </div>
