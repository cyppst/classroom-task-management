...
$strSQL4 = "SELECT * FROM examination WHERE regis_section = '".$_GET["sub_id"]."' ";
...
<ol class="breadcrumb">
    <li class="breadcrumb-item active"><h4>จัดการข้อมูลการสอบ&nbsp;/&nbsp;จัดการคะแนนหัวข้อการสอบ"<?php 
              ...
              <ul class="dropdown-menu" role="menu">
                  ...
                  <div class="btn-group">
                    ...
                    <li><a href="work_line.php?sub_id=<?=$objResult2["sub_id"]?>">เช็คงาน</a></li>
                      ...
                      <li><a href="work_score.php?sub_id=<?=$objResult2["sub_id"]?>">รวมคะแนน</a></li>                    </ul>
                  </div>
...
$(document).ready(function(){
  ...
  $("input:text",body).keyup(function(){
    ...
    if($(this).val() > title_full ){ alert('คะแนน '+$(this).val()+' เกินค่ะ'); $(this).focus();  $(this).val('0');  }         
       ...
       <form name="frmMain" method="post" action="exam_insert.php?exa_id=<?=$exa_id?>&sub_id=<?=$sub_id?>" > 
<table class="table table-bordered" id="scoring" border="1">
  ...
  <th > <div align="center">คะแนนเต็ม(<?php
...
<?php
  ...
  <td align=center><input type="text" name="std_name[]" value="0" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" ></td>
 <td></td>
  </tr>
<?php
$i++; 
