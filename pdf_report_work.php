...
//include();
	...
	$strSQL2 = "SELECT * FROM work WHERE regis_section = '".$_GET["sub_id"]."' ";
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  while($objResult2 = mysqli_fetch_assoc($objQuery2)){
                          ?>
                          <center>
<a href="report_workz.php?sub_id=<?=$objResult3["sub_id"]?>&work_id=<?=$objResult2["work_id"]?>"><button type="button" class="btn btn-success btn-fill" style="font-size: 24px;"><i class="fa fa-bar-chart"></i>&nbsp;&nbsp;&nbsp;<?php echo $objResult2['work_name'];?></button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
?>
<a href="pdf_work.php?sub_id=<?=$objResult3["sub_id"]?>"><button type="button" class="btn btn-success btn-fill" style="font-size: 24px;"> <i class="fa fa-bar-chart"></i>&nbsp;&nbsp;&nbsp;รายงานคะแนนรวม</button></a>
