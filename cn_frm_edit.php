...
$strSQL ="SELECT * FROM checkname Left join checkname_score ON (checkname.cn_id=checkname_score.cn_id) Left join student ON (checkname_score.std_id=student.std_id) WHERE checkname_score.cn_id = '".$_GET["cn_id"]."'";
...
<ol class="breadcrumb">
    <li class="breadcrumb-item active"><h4>จัดการข้อมูลคาบเรียน&nbsp;/&nbsp;แก้ไขคาบวันที่<?php 
...
<form name="frmMain" method="post" action="cn_frm_update.php?cn_id=<?=$cn_id?>&sub_id=<?=$objResult2["sub_id"]?>">
...
<input type="hidden" name="cn[]" value="<?php
  ...
  echo($objResult["cn_id"])
    ...
    ?>">
<input type="hidden" name="cns_id[]" value="<?php
  
  echo($objResult["cns_id"])
...
<td align=center><input type="radio" name="std_name[]_<?php echo $i;?>" id="std_name<?php echo $i;?>" value="1" <?php if(trim($objResult["score"]) == "1") echo "checked";?>></td>
 <td align=center><input type="radio" name="std_name[]_<?php echo $i;?>" id="std_name<?php echo $i;?>" value="2" <?php if(trim($objResult["score"]) == "2") echo "checked";?>></td>
     <td align=center><input type="radio" name="std_name[]_<?php echo $i;?>" id="std_name<?php echo $i;?>" value="3" <?php if(trim($objResult["score"]) == "3") echo "checked";?>></td>           
    <td align=center><input type="radio" name="std_name[]_<?php echo $i;?>" id="std_name<?php echo $i;?>" value="4" <?php if(trim($objResult["score"]) == "4") echo "checked";?> ></td>
<td align=center></td>
  </tr>
<?php
$i++;
...
?>
  ...
  <center>
    ...
    <a href="cn_frm_update.php?cn_id=<?=$cn_id?>&sub_id=<?=$objResult2["sub_id"]?>"><button type="submit" class="btn btn-primary">บันทึก</button>
  </center>
</form>
  </center>
